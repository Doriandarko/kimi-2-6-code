...
export const KIMI_K2_6_CONFIG = {
  firstParty: KIMI_DEFAULT_MODEL,
  bedrock: KIMI_DEFAULT_MODEL,
  vertex: KIMI_DEFAULT_MODEL,
  foundry: KIMI_DEFAULT_MODEL,
  openai: KIMI_DEFAULT_MODEL,
